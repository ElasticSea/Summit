namespace UnitySharedLibrary.Scripts
{
    ...
    public class RepeatCoroutine
    {
        ...
        /// <summary>
        /// Simple timer, no reference, wait for a delay and then execute something
        /// </summary>
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public static IEnumerator Start(float delay, float duration, int repeat, Action callback)
        {
            int i = 0;
